...
<div class="contenido">
  ...
  <div class="grid-container p-5 mt-5">
    ...
    <div class='item3 p-2 bg-white ml-5'>
      <a href="{{ route('publications')}}" class="btn btn-outline-primary mb-5">
  <span class="fa fa-download mr-2"></span>
  Ver mis publicaciones</a>


      <h6>Tu perfil se encuentra vacío. Completalo desde el botón de configuración.</h6>

...
<div class="contenido">
  <div class="contenedor-registracion container-fluid imgFondo d-flex flex-column justify-content-center align-items-center w-100">
    <div class="p-4">
      ...
      <form class="form-control p-5 margin-auto" enctype="multipart/form-data" method="POST" action="{{ route('register') }}" name="myForm" onsubmit="return validateForm()">
        @csrf
        ...
        <label for="password-confirm" class="input-group input-group-lg">
          ...
          <button type="submit" name="button" class="btn btn-lg btn-primary btn-block btn-signin mt-3 mb-3" onclick="validarCampos()">Registrar</button>

function ($) {
    ...
    function scroll($container, direction) {
        ...
        if (direction === 'left') {
            newIndex = ($container.data('homelog') - 1 + totalNum) % totalNum;
        } else if (direction === 'right') {
            newIndex = ($container.data('homelog') + 1) % $container.data('totalNum');
        } else {
            return;
        }
        ...
        $container.data('homelog', newIndex);
    ...
    function getShowIndexs($container) {
        ...
        var currentIndex = $container.data('homelog') || 0;
